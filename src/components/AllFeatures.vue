<template>
  <section class="py-36 bg-gray-900">
    <div class="container-ft">
      ...
      <div class="-mt-28 text-center">
        <div class="flex flex-wrap -mx-10">
          <div class="w-full md:w-1/3 lg:w-1/3 px-3">
            <hr class="my-6 w-96 border-gray-700" />
          </div>
          <div class="w-full md:w-1/3 lg:w-1/3 px-3">
            <h1 class="uppercase text-xs text-white mt-5">all features</h1>
          </div>
          <div class="w-full md:w-1/3 lg:w-1/3 px-3">
            <hr class="my-6 w-96 border-gray-700" />
          </div>
      ...
      <!--  -->
      <h1 class="text-5xl font-bold text-white leading-none text-center">
        simple, yet powerfull features
      </h1>
      <!--  -->
